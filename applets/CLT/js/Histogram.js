...
Histogram.prototype.valueToCanvasX = function(value) {
  ...
  return (value / step) * this.columnWidth + this.leftInset + (this.columnWidth / 2);
};
...
Histogram.prototype.drawAxes = function() {
    ...
    context.textAlign = 'left'; // Restore text align setting
    context.fillText(values[0], 2 + leftInset, canvas.height - bottomInset + 8);
    context.textAlign = 'right';
    context.fillText(values[numberOfBins - 1], canvas.width, canvas.height - bottomInset + 8);
};
