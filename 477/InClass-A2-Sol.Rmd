...
* Central Limit Theorem says, when $X_1, \ldots, X_n$ are i.i.d. random variable
...
```{r, fig.width=5, fig.height=4}
  #- Simulate White Noise (Click "play" button on your right in R studio)
...
unconditional standard deviation $SD(Y_t)$ is estimated as 0.1097.
...
Prediction rMSE of .11734 is actually higher than unconditional SD of 0.1097.  The model is not offering anything better than the prediction using unconditional SD.  This does not mean that the model is wrong or not fitting, since residual check went well.
